...
Public Class PengirimanTahunan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SastraJayaPratama.PengirimanTahunan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPengirimanTahunan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PengirimanTahunan = New PengirimanTahunan()
        rpt.Site = Me.Site
        Return rpt
    End Function
